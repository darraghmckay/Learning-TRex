        ...
        return {
            show: function(a) {
                ...
                if (!g) {
                    ...
                    j.appendChild(g);
                    g.appendChild(b);
                    l.onclick = i.onclick = TINY.box.hide;
                ...
                g.id = k.boxid;
                l.id = k.maskid;
                j.style.position = k.fixed ? "fixed" : "absolute";
                if (k.html && !k.animate) {
                    g.style.backgroundImage = "none";
                    b.innerHTML = k.html;
                    b.style.display = "";
                    g.style.width = k.width ? k.width + "px" : "auto";
                    g.style.height = k.height ? k.height + "px" : "auto"
                } else {
                    b.style.display = "none";
                    if (!k.animate && k.width && k.height) {
                        g.style.width = k.width + "px";
                        g.style.height = k.height + "px"
                    } else {
                        g.style.width = g.style.height = "100px"
                    }
                }
                if (k.mask) {
                    this.mask();
                    this.alpha(l, 1, k.opacity)
                } else {
                    this.alpha(j, 1, 100)
                }
                if (k.autohide) {
            ...
            fill: function(h, c, d, e, f, q) {
                if (c) {
                    if (k.div) {
                        newdiv = document.getElementById(k.div);
                        newdiv.style.display = "block";
                        this.psh(newdiv, e, f, q)
                    } else {
                        if (k.image) {
                            var r = new Image();
                            r.onload = function() {
                                f = f || r.width;
                                q = q || r.height;
                                TINY.box.psh(r, e, f, q)
                            };
                            r.src = k.image
                        } else {
                            if (k.iframe) {
                                this.psh('<iframe src="' + k.iframe + '" width="' + k.width + '" frameborder="0" height="' + k.height + '"></iframe>', e, f, q)
                            } else {
                                var a = window.XMLHttpRequest ? new XMLHttpRequest() : new ActiveXObject("Microsoft.XMLHTTP");
                                a.onreadystatechange = function() {
                                    if (a.readyState == 4 && a.status == 200) {
                                        g.style.backgroundImage = "";
                                        TINY.box.psh(a.responseText, e, f, q)
                                    }
                                };
                                if (d) {
                                    alert(d);
            ...
            psh: function(c, f, h, e) {
                if (k.fillwithresponse) {
                    if (typeof c == "object" || k.div) {
                        b.appendChild(c)
                    } else {
                        b.innerHTML = c
                    }
                ...
                var a = g.style.width,
                    d = g.style.height;
                if (!h || !e) {
                    g.style.width = h ? h + "px" : "";
                    g.style.height = e ? e + "px" : "";
                    b.style.display = "";
                    if (!e) {
                        e = parseInt(b.offsetHeight)
                    }
                    if (!h) {
                        h = parseInt(b.offsetWidth)
                    }
                    b.style.display = "none"
                }
                g.style.width = a;
            ...
            mask: function() {
                l.style.height = this.total(1) + "px";
                l.style.width = this.total(0) + "px"
            },
            pos: function() {
                var a;
                if (typeof k.top != "undefined") {
                    a = k.top
                } else {
                    a = (this.height() / k.topsplit) - (j.offsetHeight / 2);
                    a = a < 20 ? 20 : a
                }
                if (!k.fixed && !k.top) {
                    a += this.top()
                ...
                j.style.top = a + "px";
                j.style.left = typeof k.left != "undefined" ? k.left + "px" : (this.width() / 2) - (j.offsetWidth / 2) + "px"
            },
            alpha: function(d, c, a) {
                clearInterval(d.ai);
                if (c) {
                    d.style.opacity = 0;
            ...
            ta: function(f, a, d) {
                var e = Math.round(f.style.opacity * 100);
                if (e == a) {
                    clearInterval(f.ai);
                    if (d == -1) {
                        f.style.display = "none";
                        f == j ? TINY.box.alpha(l, -1, 0, 2) : b.innerHTML = g.style.backgroundImage = ""
                    } else {
                        if (f == l) {
                            this.alpha(j, 1, 100)
                        } else {
                            j.style.filter = "";
                            TINY.box.fill(k.html || k.url, k.url || k.iframe || k.image || k.div, k.post, k.animate, k.width, k.height)
                        }
                    }
                } else {
                    var c = a - Math.floor(Math.abs(a - e) * 0.5) * d;
                    f.style.opacity = c / 100;
                    f.style.filter = "alpha(opacity=" + c + ")"
                }
            },
            size: function(h, e, a, c) {
                if (a) {
                    clearInterval(g.si);
                    var f = parseInt(g.style.width) > h ? -1 : 1,
                        d = parseInt(g.style.height) > e ? -1 : 1;
                    g.si = setInterval(function() {
                        TINY.box.ts(h, f, e, d, c)
                    }, 20)
                } else {
                    g.style.backgroundImage = "none";
                    if (k.close) {
                    ...
                    if (k.openjs != "") {
                        if (k.html2funct == 1) {
                            window[k.openjs](c, k.farg1, k.farg2)
                        } else {
                            window[k.openjs](k.farg1, k.farg2)
                        }
                    }
                }
            },
            ts: function(n, e, f, d, c) {
                var a = parseInt(g.style.width),
                    h = parseInt(g.style.height);
                if (a == n && h == f) {
                    clearInterval(g.si);
                    g.style.backgroundImage = "none";
                    ...
                    if (a != n) {
                        g.style.width = (n - Math.floor(Math.abs(n - a) * 0.6) * e) + "px"
                    }
                    if (h != f) {
                        g.style.height = (f - Math.floor(Math.abs(f - h) * 0.6) * d) + "px"
                    }
                    this.pos()
                }
            },
            ...
            total: function(a) {
                ...
                return a ? Math.max(Math.max(d.scrollHeight, c.scrollHeight), Math.max(d.clientHeight, c.clientHeight)) : Math.max(Math.max(d.scrollWidth, c.scrollWidth), Math.max(d.clientWidth, c.clientWidth))
            }
        }
    }();
    ...
    (function() {
        ...
        function Runner(outerContainerId, opt_config) {
            ...
            this.imagesLoaded = 0;
            this.loadImages();
            this.prev_state = "clear";
            this.current_state = "clear";
            this.current_action = 0;
            this.current_reward = 0;
            this.prev_reward = 0;
            this.obstacels = {};
            this.learner = new QLearner(0.8,0.5,[0,1]);
            /*
                    Gamma : 0.2
                    Alpha : 0.4
                    Actions:
        ...
        Runner.prototype = {
            ...
            update: function() {
                ...
                if (this.activated) {
                    ...
                    if(!hasObstacles){
                        //State is going to be nothing when there are no obstacles
                        this.current_state = "clear";
                        if(this.current_action == 0){
                            this.current_reward = 5;
                        }
                        else{
                            this.current_reward = -5;
                        }
                    ...
                    if (!collision) {
                        ...
                        //He Didn't Crash So reward Him
                        this.current_reward = 100;
                        //Check if the object is really far away of not
                        if(this.obstacles != null && this.current_action == 1){
                            if(this.obstacles.x > 110)
                                this.current_reward = -10;
                        }
                        
                    } else {
                        //Need to Put a negative reward here - He Crashed
                        this.current_reward = -100;
                        this.learner.add(this.prev_state,this.current_state,this.current_reward, this.current_action);
                    ...
                    //Add The State / Reward to the Learer
                    this.learner.add(this.prev_state,this.current_state,this.current_reward, this.current_action);
            ...
            choseDinoMove: function() {
                ...
                var action = this.learner.bestAction(this.current_state);
                //Decide, based on exploration settings, whether to try the random one or use the known one
                if (action===null || action === undefined || (!this.learner.knowsAction(this.current_state, random_action) && Math.random()< 0.2)){
                    action = random_action;
                }
                //Set the Action
                this.current_action = Number(action);
                
                //Apply the Action
                if(this.current_action == 1){
                    //Make him Jump
                    jump();
                }else if(this.current_action == 0 && this.jumping){
                    //Make Him Jump Down only if He's jumping already
                    jump_down();
                }
                //Update the Stats seen on screen
                updatePlayStats(this.current_action,this.currentSpeed);
            },
            ...
            onKeyDown: function(e) {
                ...
                if (e.target != this.detailsButton || 1==1) {
                    
                    if (!this.crashed && (Runner.keycodes.JUMP[String(e.keyCode)] || e.type == Runner.events.TOUCHSTART || e.type == "keydown")) {
                        if (!this.activated) {
                            this.activated = true;
                        }
                        if (!this.tRex.jumping) {
            ...
            onKeyUp: function(e) {
                ...
                var isjumpKey = Runner.keycodes.JUMP[keyCode] || e.type == Runner.events.TOUCHEND || e.type == Runner.events.MOUSEDOWN || e.type == "keyup";
            ...
            gameOver: function() {
                ...
                //This Updates the Custom Stats
                updateScores(this.playCount,this.distanceMeter.getActualDistance(this.distanceRan),this.currentSpeed);
                 //This causes it to re-start whenever it crashes [MOD]
                this.restart();
            },
            stop: function() {
                this.activated = false;
        ...
        function checkForCollision(obstacle, tRex, opt_canvasCtx) {
            ...
            //Establish States
                /*ObstacleBox
                    ...
                    -- height
                */
                //Round the States to the Nearest 15 for Better Granularity
                var gran = 15;
                var x = (Math.round(obstacleBox.x / gran) * gran);
                //var y = (Math.round(obstacleBox.y / gran) * gran);
                r.current_state ="x" + x +  "w"+ obstacleBox.width + "s" + (Math.round(r.currentSpeed / (gran/100)) * (gran/100));
                r.obstacles = obstacleBox;
        ...
        DistanceMeter.prototype = {
            ...
            update: function(deltaTime, distance) {
                ...
                this.drawHighScore();
                return true; //possibly true|false
            },
